...
(function () {
  ...
  (function palette() {
    ...
    const ENTRIES = [
      ...
      { label: 'Veille technologique',       kind: 'Section',  href: base + 'index.html#veille' },
      ...
      { label: 'Pla\'Net, planning MediaSchool', kind: 'Page', href: base + 'pages/projets-perso.html#planet' },
